...
DROP POLICY IF EXISTS "Tout le monde peut lire les comparaisons" ON comparison_items;
...
DROP POLICY IF EXISTS "Tout le monde peut lire la comparaison avec les agences" ON agency_comparison_features;
