                  ...
                  {user ? (
                    <>
                      ...
                      {profile?.role === 'student' && (
                        <>
                          {/* Mes reservations - collapsible submenu */}
                          <div>
                            <button
                              onClick={() => setOpenSubmenu(openSubmenu === 'student-bookings' ? null : 'student-bookings')}
                              className="w-full text-left px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 flex items-center justify-between"
                            >
                              <div className="flex items-center space-x-3">
                              ...
                              <div className="flex items-center space-x-2">
                                ...
                                <ChevronDown className={`h-4 w-4 text-gray-400 transition-transform duration-200 ${openSubmenu === 'student-bookings' ? 'rotate-180' : ''}`} />
                              </div>
                            </button>
                            {openSubmenu === 'student-bookings' && (
