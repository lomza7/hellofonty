import { X, MapPin, Key, Wifi, Home, Image as ImageIcon, Video, KeyRound } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen p-4 text-center">
        ...
        <div className="inline-block w-full max-w-5xl my-auto max-h-[calc(100vh-2rem)] overflow-hidden text-left align-middle transition-all transform bg-white shadow-2xl rounded-2xl">
          ...
          <div className="p-6 max-h-[calc(100vh-300px)] sm:max-h-[calc(100vh-250px)] overflow-y-auto">
