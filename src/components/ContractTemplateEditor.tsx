...
const AVAILABLE_VARIABLES = [
  ...
  { key: '{{landlord_address}}', label: 'Adresse du bailleur' },
  { key: '{{landlord_email}}', label: 'E-mail du bailleur' },
  { key: '{{tenant_email}}', label: 'E-mail du locataire' },
  { key: '{{tenant_permanent_address}}', label: 'Domicile principal du locataire' },
